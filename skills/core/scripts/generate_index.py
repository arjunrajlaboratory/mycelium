...
def update_index_counts_only(living_dir: Path) -> None:
    ...
    if QUICK_REF_BEGIN in existing and QUICK_REF_END in existing:
        ...
        # Legacy migration: INDEX.md without sentinels is treated as fully
        # machine-managed and replaced entirely. All existing INDEX.md files
        # were auto-generated by generate_index.py and contain no manually
