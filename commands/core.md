...
description: >
  ...
  for later, or exploring unfamiliar data. This skill manages a .living/
  directory framework that registers analyses, datasets, and decisions. It
  handles: project initialization ("set up mycelium", "initialize living repo"),
  knowledge capture ("crystallize this learning", "record this finding"),
  future work tracking ("add a todo idea", "track this for later"), dataset
